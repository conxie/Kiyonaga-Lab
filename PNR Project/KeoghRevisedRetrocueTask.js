...
function loadExpVarRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of loadExpVarComponents)
...
function expBlkLoopBegin(expBlkLoopScheduler, snapshot) {
  return async function() {
    ...
    for (const thisExpBlk of expBlk) {
...
function blockInitRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of blockInitComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trlInitRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trlInitComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fixationCircleRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixationCircleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function preCueRestRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of preCueRestComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function retrocueRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of retrocueComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function delayCode_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of delayCode_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
